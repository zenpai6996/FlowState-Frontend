...
function TabsList({
	...
	return (
		<TabsPrimitive.List
			data-slot="tabs-list"
			className={cn(
				"bg-stone-100 text-stone-500 inline-flex h-9 w-fit items-center justify-center rounded-xl p-[5px] dark:bg-muted border dark:border-stone-800 dark:text-stone-400",
				className
			)}
			{...props}
		/>
