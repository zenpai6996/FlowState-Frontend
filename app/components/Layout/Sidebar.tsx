import { Bolt,  ChevronLeft, ChevronRightIcon, Component, Home, ListChecks, LogOut, MonitorCheck, MonitorCog, Users2 } from 'lucide-react';
...
export const SidebarComponent = ({ currentWorkspace, isMobileOpen }: { currentWorkspace: Workspace | null, isMobileOpen: boolean }) => {
    ...
    >
        <div className='flex h-14 items-center dark:border-b rounded-r-2xl rounded-l-2xl border-accent px-4 mb-4'>
          ...
          <Button
            variant={"glassMirror"}
            size={"icon"}
            className={cn('ml-auto hidden md:block hover:text-primary dark:hover:text-primary transition-colors duration-300 ease-in-out rounded-full', isCollapsed && "ml-1")}
